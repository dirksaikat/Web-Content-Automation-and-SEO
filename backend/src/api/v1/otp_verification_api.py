...
async def verify_account(
    ...
    if (
        ...
        await otp_repository.delete_otp(email=data.email, code=data.otp, purpose="account_verification", db=db)
    ...
    await otp_repository.delete_otp(email=data.email, code=hash_otp(data.otp), purpose="account_verification",db=db)
    await db.commit()
